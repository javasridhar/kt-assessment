    ...
    override fun getLocationUpdates(interval: Long): Flow<Location> {
        return callbackFlow {
            if (!context.hasLocationPermission()) {
                throw LocationClient.LocationException(Constants.LOCATION_SERVICE_EXCEPTION_PERMISSION_TYPE)
            }
            ...
            if (!isGpsEnabled && !isNetworkEnabled)
                throw LocationClient.LocationException(Constants.LOCATION_SERVICE_EXCEPTION_GPS_TYPE)
